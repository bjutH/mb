    ...
    <div class="container-fluid">
        ...
        <div>
            <ul class="nav navbar-nav navbar-right" >
                ...
                <li style="border-right: 1px dashed #cccccc"><a href="#0" onclick="javascript:window.location.href='/homepage/taskmanagement'"><span class="glyphicon glyphicon-calendar"></span>任务管理</a></li>
        ...
        <div class="modal-content">
            ...
            <form class="form-inline" role="form" action="/homepage/updatepassword" method="post">
                <div class="modal-body">
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;原始密码：<input id="inp1" type="text" name="oldPassword" class="form-control" placeholder="请输入原密码"></p>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;新密码：<input id="inp2" type="text" name="newPassword" class="form-control" placeholder="请输入新密码"></p>
                    <p>再次输入新密码：<input id="inp3" type="text" name="renewPassword" class="form-control" placeholder="请再次输入新密码"></p>
                </div>
...
<script>
    function checkform10() {
        ...
        if (document.getElementById('inp3').value != document.getElementById('inp2').value) {
            alert('两次输入新密码不同！');
            document.getElementById('ipt2').focus();
            return false;
        }
